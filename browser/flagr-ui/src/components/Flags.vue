                                    ...
                                    >
                                        ...
                                        <el-dropdown-menu slot="dropdown">
                                            <el-dropdown-item
                                                ...
                                                :disabled="!newFlag.description"
                                                >Create Simple Boolean
                                                Flag</el-dropdown-item
                                            >
                                        </el-dropdown-menu>
                                    </el-dropdown>
                                </template>
                    ...
                    >
                        ...
                        >
                            <template slot-scope="scope">
                                <el-tag
                                    :type="
                                        scope.row.enabled ? 'primary' : 'danger'
                                    "
                                    disable-transitions
                                    >{{
    ...
    methods: {
        ...
        restoreFlag(row) {
            this.$confirm(
                ...
                Axios.put(`${API_URL}/flags/${row.id}/restore`).then(
                    (response) => {
                        let flag = response.data;
                        this.$message.success(`Flag updated`);
                        this.flags.push(flag);
                        this.deletedFlags = this.deletedFlags.filter(function (
                            el
                        ) {
